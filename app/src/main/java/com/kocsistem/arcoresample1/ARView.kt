...
import com.kocsistem.arcoresample1.helpers.SnackbarHelper
import com.kocsistem.arcoresample1.helpers.TapHelper

/** Contains UI elements for Hello AR. */
class HelloArView(val activity: ARActivity) : DefaultLifecycleObserver {
    val root = View.inflate(activity, R.layout.ar_activity_layout, null)
